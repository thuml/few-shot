...
class WideResNet(nn.Module):
    def __init__(self, depth, widen_factor=1, stride=1, drop_rate=0.5, flatten=True):
        ...
        self.final_feat_dim = nChannels[-1] if self.flatten else [nChannels[-1], 20, 20]
    ...
    @staticmethod
    def _make_layer(nb_layers, in_planes, out_planes, block, stride, drop_rate):
        layers = []
...
def wrn_28_10(flatten=True):
    return WideResNet(28, 10, drop_rate=cfg.train.drop_rate, flatten=flatten)
